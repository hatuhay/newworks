!(function () {
  ...
  function i(t) {
    ...
    if (((this.length = 0), t))
      if (
        (t = "string" == typeof t ? this.find(t) : t).nodeType ||
        t === t.window
      )
    ...
    t(i.prototype, {
      ...
      removeClass: function (t) {
        for (
          ...
          (e = this[--a]).className = e.className.replace(s, n).replace(o, "");
        return this;
      },
      on: function (t, e) {
    ...
    return (
      f.extend(i.prototype, {
          ...
          function i() {
            ...
            document.body.appendChild(s),
              i &&
                ...
                s.style[t] !== undefined &&
                  ((s.style[t] = "translateZ(0)"),
                  (e = window
                    .getComputedStyle(s)
                    .getPropertyValue(i.prefix + "transform")),
                  (n.transform = {
                    prefix: i.prefix,
                    name: t,
                    translate: !0,
        ...
        play: function (t) {
          var i = this,
            e =
              this.index + ("rtl" === this.options.slideshowDirection ? -1 : 1);
          window.clearTimeout(this.timeout),
            ...
            1 < this.elements[this.index] &&
              (this.timeout = this.setTimeout(
                (!this.requestAnimationFrame && this.slide) ||
                  function (t, e) {
                    i.animationFrameId = i.requestAnimationFrame.call(
                      window,
                      function () {
                        i.slide(t, e);
                      }
          ...
          s
            ? ((n = this),
              ...
              (a = window.setInterval(function () {
                ...
                if (s < t)
                  return (
                    (n.slidesContainer[0].style.left = i + "px"),
                    n.ontransitionend(),
                    void window.clearInterval(a)
                  );
                n.slidesContainer[0].style.left =
                  (i - e) * (Math.floor((t / s) * 100) / 100) + e + "px";
              }, 4)))
        ...
        onmouseout: function (t) {
          ...
          this.touchStart &&
            ((e = t.target),
            ((i = t.relatedTarget) && (i === e || f.contains(e, i))) ||
              this.onmouseup(t));
        },
          ...
          if (!(1 < s.length || (o && 1 !== o)))
            if (
              ...
              this.options.carousel ||
                this.translateY(a, this.touchDelta.y + this.positions[a], 0);
            else
              for (
                t.preventDefault(),
                  window.clearTimeout(this.timeout),
        ...
        ontouchend: function (t) {
          ...
          var e = this.index,
            ...
            o = 20 < i,
            a =
              (!e && 0 < this.touchDelta.x) ||
              (e === this.num - 1 && this.touchDelta.x < 0),
            l =
              !o &&
              this.options.closeOnSwipeUpOrDown &&
              20 < Math.abs(this.touchDelta.y);
          this.options.continuous && (a = !1),
            ...
            this.isScrolling
              ...
              ? ((i = e + t),
                ...
                (a = -s * t),
                this.options.continuous
                  ? (this.move(this.circle(i), o, 0),
                    this.move(this.circle(e - 2 * t), a, 0))
                  : 0 <= i && i < this.num && this.move(i, o, 0),
                this.move(e, this.positions[e] + o, n),
                this.move(
                  this.circle(l),
                  this.positions[this.circle(l)] + o,
                  n
                ),
                (e = this.circle(l)),
                this.onslide(e))
              : this.options.continuous
              ? (this.move(this.circle(e - 1), -s, n),
                this.move(e, 0, n),
                this.move(this.circle(e + 1), s, n))
              : (e && this.move(e - 1, -s, n),
                this.move(e, 0, n),
                e < this.num - 1 && this.move(e + 1, s, n));
        },
        ...
        oncomplete: function (t) {
          ...
          i &&
            ...
            f(s).removeClass(this.options.slideLoadingClass),
            "error" === t.type
              ? (f(s).addClass(this.options.slideErrorClass),
                (this.elements[e] = 3))
              : (this.elements[e] = 2),
            i.clientHeight > this.container[0].clientHeight &&
              (i.style.maxHeight = this.container[0].clientHeight),
        ...
        onkeydown: function (t) {
          switch (t.which || t.keyCode) {
            case 13:
              this.options.toggleControlsOnEnter &&
        ...
        handleClick: function (t) {
          ...
          n(e.toggleClass)
            ...
            ? e.closeOnSlideClick
              ? (this.preventDefault(t), this.close())
              : e.toggleControlsOnSlideClick &&
                (this.preventDefault(t), this.toggleControls())
            : s.parentNode &&
              s.parentNode === this.slidesContainer[0] &&
              e.toggleControlsOnSlideClick &&
              (this.preventDefault(t), this.toggleControls());
        },
        onclick: function (t) {
        ...
        updateActiveSlide: function (t, e) {
          for (
            ...
            (i = a.pop()),
              f(n[i.index])[i.method](o.slideActiveClass),
              (s = this.circle(i.index - 1)),
              (o.continuous || s < i.index) &&
                f(n[s])[i.method](o.slidePrevClass),
              (s = this.circle(i.index + 1)),
              (o.continuous || s > i.index) &&
                f(n[s])[i.method](o.slideNextClass);
          this.slides[t].setAttribute("aria-hidden", "true"),
            this.slides[e].removeAttribute("aria-hidden");
        },
        handleSlide: function (t, e) {
          this.options.continuous || this.updateEdgeClasses(e),
            this.updateActiveSlide(t, e),
            this.loadElements(e),
            this.options.unloadElements && this.unloadElements(t, e),
            this.setTitle(e);
        },
        onslide: function (t) {
          this.handleSlide(this.index, t),
            (this.index = t),
        ...
        setTitle: function (t) {
          ...
          e.length &&
            ...
            t && e[0].appendChild(document.createTextNode(t)));
        },
          ...
          if (
            ("string" != typeof u &&
              ...
              (n =
                ...
                this.support.source &&
                this.getItemProperty(t, d.sourcesProperty)),
            ...
            l && (p.title = l),
            r && (p.alt = r),
            f(p).on("load error", function m(t) {
              if (!s) {
            ...
            for (
              i = this.picturePrototype.cloneNode(!1), h = 0;
              h < n.length;
              h += 1
            )
        ...
        createElement: function (t, e) {
          ...
          return (
            i ||
              ...
              this.setTimeout(e, [{ type: "error", target: i }])),
            f(i).addClass(this.options.slideContentClass),
            i
          );
        },
        iteratePreloadRange: function (t, e) {
          for (
            var i = this.num,
              s = this.options,
              n = Math.min(i, 2 * s.preloadRange + 1),
              o = t,
              a = 0;
            a < n;
            a += 1
        ...
        loadElement: function (t) {
          this.elements[t] ||
            (this.slides[t].firstChild
              ? (this.elements[t] = f(this.slides[t]).hasClass(
                  this.options.slideErrorClass
                )
                  ? 3
                  : 2)
              : ((this.elements[t] = 1),
                f(this.slides[t]).addClass(this.options.slideLoadingClass),
                this.slides[t].appendChild(
                  this.createElement(this.list[t], this.proxyListener)
                )));
        },
        ...
        unloadElements: function (t, i) {
          ...
          this.iteratePreloadRange(t, function (t) {
            ...
            s < e &&
              e + s < this.num &&
              (this.unloadSlide(t), delete this.elements[t]);
          });
        },
        addSlide: function (t) {
        ...
        initSlides: function (t) {
          ...
          for (
            t ||
              ...
              f(this.slidePrototype).addClass(this.options.slideClass),
        ...
        getItemProperty: function (t, e) {
          ...
          return (i =
            (i = i === undefined ? t[e] : i) === undefined
              ? this.getNestedProperty(t, e)
              : i);
        },
        ...
        initEventListeners: function () {
          ...
          f(window).on("resize", e),
            f(window).on("hashchange", e),
            f(document.body).on("keydown", e),
            this.container.on("click", e),
            this.support.touch
              ? t.on("touchstart touchmove touchend touchcancel", e)
              : this.options.emulateTouchEvents &&
                this.support.transition &&
                t.on("mousedown mousemove mouseup mouseout", e),
        ...
        destroyEventListeners: function () {
          ...
          f(window).off("resize", e),
            f(document.body).off("keydown", e),
            this.container.off("click", e),
            this.support.touch
              ? t.off("touchstart touchmove touchend touchcancel", e)
              : this.options.emulateTouchEvents &&
                this.support.transition &&
                t.off("mousedown mousemove mouseup mouseout", e),
        ...
        initOptions: function (t) {
          (this.options = f.extend({}, this.options)),
            ((t && t.carousel) ||
              (this.options.carousel && (!t || !1 !== t.carousel))) &&
              f.extend(this.options, this.carouselOptions),
            f.extend(this.options, t),
            this.num < 3 &&
      ...
      a.extend(e, {
        createIndicator: function (t) {
          ...
          return (
            this.options.thumbnailIndicators &&
              (e =
                (e = o ? this.getItemProperty(t, o) : e) === undefined &&
                (i = t.getElementsByTagName && a(t).find("img")[0])
                  ? i.src
                  : e) &&
        ...
        addIndicator: function (t) {
          ...
          this.indicatorContainer.length &&
            ((e = this.createIndicator(this.list[t])).setAttribute(
              "data-index",
              t
            ),
        ...
        setActiveIndicator: function (t) {
          this.indicators &&
            ...
            (this.activeIndicator = a(this.indicators[t])),
      ...
      C.extend(e, {
        ...
        videoFactory: function (t, e, i) {
          ...
          if (
            ...
            C(u).addClass(l.videoCoverClass).hasClass(l.toggleClass) ||
              v.push(u),
            (u.draggable = !1),
            y && ((r.title = y), p.setAttribute("aria-label", y)),
            g && (u.style.backgroundImage = 'url("' + g + '")'),
            c.setAttribute
              ? l.videoPlaysInline && c.setAttribute("playsinline", "")
              : h.addClass(l.videoIframeClass),
            (c.preload =
              this.getItemProperty(t, l.videoPreloadProperty) || "none"),
            this.support.source && f)
          )
            for (o = 0; o < f.length; o += 1)
              c.appendChild(C.extend(this.sourcePrototype.cloneNode(!1), f[o]));
          return (
            m && (c.src = m),
            (p.href = m || (f && f.length && f[0].src)),
            c.play &&
              c.pause &&
              ((i || C(c))
                .on("error", function () {
                ...
                .on("pause", function () {
                  c.seeking ||
                    ((n = !1),
                    h
                      .removeClass(a.options.videoLoadingClass)
                      .removeClass(a.options.videoPlayingClass),
                ...
                .on("playing", function () {
                  (n = !1),
                    ...
                    h
                      .removeClass(a.options.videoLoadingClass)
                      .addClass(a.options.videoPlayingClass);
                })
                .on("play", function () {
                  window.clearTimeout(a.timeout),
                    (n = !0),
                    h.addClass(a.options.videoLoadingClass),
                    a.container.hasClass(a.options.controlsClass)
                      ? ((s = !0),
                        a.container.removeClass(a.options.controlsClass))
                      : (s = !1),
                    (c.controls = !0),
                    (a.activeVideo = c);
                }),
    ...
    return (
      l.extend(o.prototype, {
        ...
        loadAPI: function () {
          ...
          t || ((t = document.createElement("script")).src = s),
            l(t).on("load", a),
      ...
      l.extend(e, {
        ...
        textFactory: function (t, e) {
          ...
          return s
            ? (this.getItemProperty(t, i.urlProperty) === undefined &&
                (t[i.urlProperty] = "https://vimeo.com/" + s),
              (a += 1),
              this.videoFactory(
                t,
                e,
    ...
    return (
        ...
        onStateChange: function (t) {
          switch ((window.clearTimeout(this.pauseTimeout), t.data)) {
            ...
            case YT.PlayerState.PAUSED:
              this.pauseTimeout = i.setTimeout.call(
                this,
                this.onPause,
                null,
                500
      ...
      t.extend(i, {
        ...
        textFactory: function (t, e) {
          ...
          return s
            ? (this.getItemProperty(t, i.urlProperty) === undefined &&
                (t[i.urlProperty] = "https://www.youtube.com/watch?v=" + s),
              this.getItemProperty(t, i.videoPosterProperty) === undefined &&
                (t[i.videoPosterProperty] =
                  "https://img.youtube.com/vi/" + s + "/maxresdefault.jpg"),
              this.videoFactory(
                t,
                e,
                new o(s, i.youTubePlayerVars, i.youTubeClickToPlay)
              ))
            : n.call(this, t, e);
        },
      }),
